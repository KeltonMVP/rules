...
* The RPG website offers you the possibility to recover the unique 2FA activation key through the email address set on the account.
...
## How do I use the key received in the application?
...
5. Then the application generates the unique 6-digit code that you can use again to access your account.
...
* [Account - Password Recovery](password-recovery.en.md)
* [Account - Account Recovery](account-recovery.en.md)
