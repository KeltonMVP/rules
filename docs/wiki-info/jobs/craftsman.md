...
<figure markdown="span">
  ...
  <figcaption>Interfata comenzii /craft #1</figcaption>
</figure>
...
<figure markdown="span">
  ![Biz House Upgrade](/images/wiki/general/Hubiz.png){ width="450" }
  <figcaption>Locatia bizului House Upgrade #4</figcaption>
</figure>

<figure markdown="span">
  ![Interfata /buy](/images/wiki/general/Craftbuy.png){ width="500" }
...
* Jobul are in principal patru activitati:
    * inchirierea unui dulgher, unei drujbe si a unei masti de protectie de la businessul Craftsman (**ID 160**)
    * preluarea materialelor necesare crearii obiectelor (*lemn, bumbac, aur si argint*)
    * prelucrarea materialelor pentru a crea un produs finit
    * distribuirea obiectului finit si revenirea la locatia initiala a jobului
* Inchirierea este valabila timp de 24 de ore si este obligatorie pentru a putea lucra la job, preturile inchirierii acestora fiind in felul urmator:
    * *Dulgherul* - $1000 pentru 24 de ore
    * *Drujba* - $500 pentru 24 de ore
    * *Masca* - $500 pentru 24 de ore
* Materialele pot fi preluate prin lucrul la joburi, pentru a putea castiga acele materiale va fi necesar sa aveti **minim skill 5** la urmatoarele joburi:
    * pentru a obtine *Lemn* va trebui sa munciti la jobul Taietor de Lemne
...
* Veti putea crea obiecte artizanale in functie de skillul pe care il aveti dupa cum urmeaza:
    * intre Skill 1 si Skill 3 veti putea prelucra doar scaune
    * intre Skill 4 si Skill 6 veti putea prelucra scaune si mese
...
* **Scaunul 1** - este necesar sa aveti minim 12 bucati de lemn, 0 buc. de bumbac, 76 buc. de argint si 25 de lingouri de aur.
* **Scaunul 2** - este necesar sa aveti minim 13 bucati de lemn, 0 buc. de bumbac, 83 buc. de argint si 27 de lingouri de aur.
* **Scaunul 3** - este necesar sa aveti minim 14 bucati de lemn, 0 buc. de bumbac, 91 buc. de argint si 30 de lingouri de aur.
* **Scaunul 4** - este necesar sa aveti minim 15 bucati de lemn, 0 buc. de bumbac, 98 buc. de argint si 32 de lingouri de aur.
* **Scaunul 5** - este necesar sa aveti minim 16 bucati de lemn, 10 buc. de bumbac, 106 buc. de argint si 35 de lingouri de aur.

### Mese

* **Masa 1** - este necesar sa aveti minim 18 bucati de lemn, 0 buc. de bumbac, 114 buc. de argint si 37 de lingouri de aur.
* **Masa 2** - este necesar sa aveti minim 19 bucati de lemn, 0 buc. de bumbac, 121 buc. de argint si 40 de lingouri de aur.
* **Masa 3** - este necesar sa aveti minim 20 bucati de lemn, 0 buc. de bumbac, 129 buc. de argint si 42 de lingouri de aur.
* **Masa 4** - este necesar sa aveti minim 21 bucati de lemn, 0 buc. de bumbac, 136 buc. de argint si 45 de lingouri de aur.
* **Masa 5** - este necesar sa aveti minim 22 bucati de lemn, 20 buc. de bumbac, 144 buc. de argint si 47 de lingouri de aur.

### Accesorii

* **Skateboard** - este necesar sa aveti minim 24 bucati de lemn, 0 buc. de bumbac, 152 buc. de argint si 50 de lingouri de aur.
* **Evantai** - este necesar sa aveti minim 25 bucati de lemn, 0 buc. de bumbac, 159 buc. de argint si 52 de lingouri de aur.
* **Scaun pentru plaja** - este necesar sa aveti minim 26 bucati de lemn, 0 buc. de bumbac, 167 bucati de argint si 55 de lingouri de aur.
* **Rama** - este necesar sa aveti minim 27 bucati de lemn, 0 buc. de bumbac, 174 buc. de argint si 57 de lingouri de aur.
* **Televizor** - este necesar sa aveti minim 28 bucati de lemn, 30 buc. de bumbac, 182 buc. de argint si 60 de lingouri de aur.

### Usi

* **Usa 1** - este necesar sa aveti minim 30 bucati de lemn, 0 buc. de bumbac, 190 buc. de argint si 62 de lingouri de aur.
* **Usa 2** - este necesar sa aveti minim 31 bucati de lemn, 0 buc. de bumbac, 197 buc. de argint si 65 de lingouri de aur.
* **Usa 3** - este necesar sa aveti minim 32 bucati de lemn, 0 buc. de bumbac, 205 buc. de argint si 67 de lingouri de aur.
* **Usa 4** - este necesar sa aveti minim 33 bucati de lemn, 0 buc. de bumbac, 212 buc. de argint si 70 de lingouri de aur.
* **Usa 5** - este necesar sa aveti minim 34 bucati de lemn, 40 buc. de bumbac, 220 buc. de argint si 72 de lingouri de aur.

## Castiguri si particularitati in functie de skill
...
Puteti face rost de lemne lucrand la Taietor de Lemne, castigul de lemne este in felul urmator:

* Taietor de Lemne Skill 5 - obtineti 10 lemne + random(9)
* Taietor de Lemne Skill 6 - obtineti 15 lemne + random(9)
* Taietor de Lemne Skill 7 - obtineti 20 de lemne + random(9)
* Taietor de Lemne Skill 8 - obtineti 25 de lemne + random(9)
* Taietor de Lemne Skill 9 - obtineti 30 de lemne + random(9)
* Taietor de Lemne Skill 10 - obtineti 35 de lemne + random(9)

### Bumbacul

Puteti face rost de bumbac lucrand la Farmer, castigul de bumbac este in felul urmator:

* Farmer Skill 5 - obtineti 1 bumbac + random(9) pentru fiecare cactus cules
* O parcela poate avea 16 cactusi, pentru un castig final de 16*(1+random(9)) cu nota ca random(9) va varia pentru fiecare cactus cules.

### Aurul

Puteti face rost de aur lucrand la Miner, castigul de lingouri de aur este in felul urmator:

* Miner Skill 5 - 10 lingouri de aur + random(9)
* Miner Skill 6 - 15 lingouri de aur + random(9)
* Miner Skill 7 - 20 de lingouri de aur + random(9)
* Miner Skill 8 - 25 de lingouri de aur + random(9)
* Miner Skill 9 - 30 de lingouri de aur + random(9)
* Miner Skill 10 - 35 de lingouri de aur + random(9)

### Argintul

Puteti face rost de argint lucrand la Muncitor la Cariera, castigul de argint este in felul urmator:

* Muncitor la Cariera Skill 5 - 10 argint + random(9)
* Muncitor la Cariera Skill 6 - 15 argint + random(9)
* Muncitor la Cariera Skill 7 - 20 argint + random(9)
* Muncitor la Cariera Skill 8 - 25 argint + random(9)
* Muncitor la Cariera Skill 9 - 30 argint + random(9)
* Muncitor la Cariera Skill 10 - 35 argint + random(9)

**Nota:** **random(9)** - reprezinta un numar aleatoriu de la 0 la 9
...
- Provenit din: Ford E-Series 1980's & 1990's
- Numar de locuri: 4
- Skillul necesar: 1, 2, 3, 4
- Tunabil: TransFender
