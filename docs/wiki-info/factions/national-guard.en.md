...
National Guard, a military institution, located in the heart of the Las Venturas desert, in Area 51, ensures control in critical situations. Organized and strategically deployed interventions lead to successful mission completion and danger elimination. Being equipped with fighter jets, Hunter helicopters and vehicles that can cross any terrain and weather, department members arrive on time anywhere, anytime. To enter this army you must have appropriate behavior and language. National Guard has 2 types of training to teach you how to manage in the air, as well as in handling weapons. If you manage to enter this department as rank 1 you will deal with order and discipline in prison. What exactly does this mean? You need to make sure that prisoners receive water/food whenever needed, open their cells at a certain time interval for a break, and so on. Also, prisoners can be punished. If they hit each other, if they hit the bars, they will be punished according to the severity of the situation.

After you manage to advance in rank, namely rank 2+, you will have the opportunity to go after criminals who rob the bank or those who do not cooperate when you are in pursuit of them. Over time, you have the opportunity to advance in rank, but for this you must have seniority, special behavior, appropriate language and be able to work in a team regardless of the situation.

## Faction Skins

**Note: Skin ranks are general, these may differ depending on the faction's internal regulations.**

### Skin ID 179 - Leader / Rank 6

<figure markdown="span">![Skin 179](/images/wiki/skins/179.png){ width="250" }<figcaption>General (Leader) / Colonel (6)</figcaption></figure>

### Skin ID 287 - Rank 5, 4, 3 and 2
...
<figure markdown="span">![Skin 298](/images/wiki/skins/298.png){ width="250" }<figcaption>Skin 298</figcaption></figure>
...
2. For a suspect caught escaping: earnings = [2,43 * (247 + random(15) + 100)] * 1,1

#### Rank 2
1. For an arrested suspect: earnings = [2,43 * (247 + random(15) + 10 * WantedLevel)] * 1,2
2. For a suspect caught escaping: earnings = [2,43 * (247 + random(15) + 100)] * 1,2

#### Rank 3
1. For an arrested suspect: earnings = [2,43 * (247 + random(15) + 10 * WantedLevel)] * 1,3
2. For a suspect caught escaping: earnings = [2,43 * (247 + random(15) + 100)] * 1,3

#### Rank 4
1. For an arrested suspect: earnings = [2,43 * (247 + random(15) + 10 * WantedLevel)] * 1,4
2. For a suspect caught escaping: earnings = [2,43 * (247 + random(15) + 100)] * 1,4

#### Rank 5
1. For an arrested suspect: earnings = [2,43 * (247 + random(15) + 10 * WantedLevel)] * 1,5
2. For a suspect caught escaping: earnings = [2,43 * (247 + random(15) + 100)] * 1,5

#### Rank 6 or Leader
1. For an arrested suspect: earnings = [2,43 * (247 + random(15) + 10 * WantedLevel)] * 1,6
2. For a suspect caught escaping: earnings = [2,43 * (247 + random(15) + 100)] * 1,6
...
2. For a suspect caught escaping: earnings = [2,43 * (247 + random(15) + 100)] * 1,7

#### Rank 3
1. For an arrested suspect: earnings = [2,43 * (247 + random(15) + 10 * WantedLevel)] * 1,8
2. For a suspect caught escaping: earnings = [2,43 * (247 + random(15) + 100)] * 1,8

#### Rank 4
1. For an arrested suspect: earnings = [2,43 * (247 + random(15) + 10 * WantedLevel)] * 1,9
2. For a suspect caught escaping: earnings = [2,43 * (247 + random(15) + 100)] * 1,9

#### Rank 5
1. For an arrested suspect: earnings = [2,43 * (247 + random(15) + 10 * WantedLevel)] * 2
2. For a suspect caught escaping: earnings = [2,43 * (247 + random(15) + 100)] * 2

#### Rank 6 or Leader
1. For an arrested suspect: earnings = [2,43 * (247 + random(15) + 10 * WantedLevel)] * 2,1
2. For a suspect caught escaping: earnings = [2,43 * (247 + random(15) + 100)] * 2,1
...
- [Apply to National Guard](http://www.rpg.b-zone.ro/factions/apply/ng)
- [National Guard Members](http://www.rpg.b-zone.ro/factions/members/ng)
- [National Guard Complaints](http://www.rpg.b-zone.ro/factions/reports/ng)
- [National Guard Activity Reports](http://www.rpg.b-zone.ro/factions/factionReports/ng)
- [National Guard Logs](http://www.rpg.b-zone.ro/factions/logs/ng)
- [National Guard Applications List](http://www.rpg.b-zone.ro/factions/applications/ng)
