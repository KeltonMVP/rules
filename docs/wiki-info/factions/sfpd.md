...
San Fierro Police Department este o institutie guvernamentala ce elimina criminalitatea de pe strazile San Fierro, cu ajutorul armelor moderne si autospecialelor ce le au in subordine.
Ca si in cazul celorlalte departamente locale, LS Police Department si LV Police Department, factiunea SF Police Department este impartita in doua echipe principale:

1. Echipa rutiera
2. Echipa S.W.A.T.

Echipa rutiera se ocupa cu supravegherea traficului si amendarea jucatorilor ce calca prea tare acceleratia si care sfideaza regulile de circulatie.
...
#### Rank 1
1. Pentru un suspect arestat: castig = [2,43 * (247 + random(15) + 10 * WantedLevel)] * 1,1
2. Pentru o amenda: castig = 2 * pretul_amenzii
3. Pentru un suspect prins evadand: castig = [2,43 * (247 + random(15) + 100)] * 1,1

#### Rank 2
1. Pentru un suspect arestat: castig = [2,43 * (247 + random(15) + 10 * WantedLevel)] * 1,2
2. Pentru o amenda: castig = 2 * pretul_amenzii
3. Pentru un suspect prins evadand: castig = [2,43 * (247 + random(15) + 100)] * 1,2

#### Rank 3
1. Pentru un suspect arestat: castig = [2,43 * (247 + random(15) + 10 * WantedLevel)] * 1,3
2. Pentru o amenda: castig = 2 * pretul_amenzii
3. Pentru un suspect prins evadand: castig = [2,43 * (247 + random(15) + 100)] * 1,3

#### Rank 4
1. Pentru un suspect arestat: castig = [2,43 * (247 + random(15) + 10 * WantedLevel)] * 1,4
2. Pentru o amenda: castig = 2 * pretul_amenzii
3. Pentru un suspect prins evadand: castig = [2,43 * (247 + random(15) + 100)] * 1,4

#### Rank 5
1. Pentru un suspect arestat: castig = [2,43 * (247 + random(15) + 10 * WantedLevel)] * 1,5
2. Pentru o amenda: castig = 2 * pretul_amenzii
3. Pentru un suspect prins evadand: castig = [2,43 * (247 + random(15) + 100)] * 1,5

#### Rank 6 sau Lider
1. Pentru un suspect arestat: castig = [2,43 * (247 + random(15) + 10 * WantedLevel)] * 1,6
2. Pentru o amenda: castig = 2 * pretul_amenzii
3. Pentru un suspect prins evadand: castig = [2,43 * (247 + random(15) + 100)] * 1,6
...
#### Rank 2
1. Pentru un suspect arestat: castig = [2,43 * (247 + random(15) + 10 * WantedLevel)] * 1,7
2. Pentru o amenda: castig = 2 * pretul_amenzii
3. Pentru un suspect prins evadand: castig = [2,43 * (247 + random(15) + 100)] * 1,7

#### Rank 3
1. Pentru un suspect arestat: castig = [2,43 * (247 + random(15) + 10 * WantedLevel)] * 1,8
2. Pentru o amenda: castig = 2 * pretul_amenzii
3. Pentru un suspect prins evadand: castig = [2,43 * (247 + random(15) + 100)] * 1,8

#### Rank 4
1. Pentru un suspect arestat: castig = [2,43 * (247 + random(15) + 10 * WantedLevel)] * 1,9
2. Pentru o amenda: castig = 2 * pretul_amenzii
3. Pentru un suspect prins evadand: castig = [2,43 * (247 + random(15) + 100)] * 1,9

#### Rank 5
1. Pentru un suspect arestat: castig = [2,43 * (247 + random(15) + 10 * WantedLevel)] * 2
2. Pentru o amenda: castig = 2 * pretul_amenzii
3. Pentru un suspect prins evadand: castig = [2,43 * (247 + random(15) + 100)] * 2

#### Rank 6 sau Lider
1. Pentru un suspect arestat: castig = [2,43 * (247 + random(15) + 10 * WantedLevel)] * 2,1
2. Pentru o amenda: castig = 2 * pretul_amenzii
3. Pentru un suspect prins evadand: castig = [2,43 * (247 + random(15) + 100)] * 2,1
...
Utilizarea comenzilor se face doar in interiorul unui vehicul de politie.<br>
Comanda /startradar foloseste un parametru, viteza maxima admisa.
...
### /ms
Tastarea acestei comenzi va trimite un mesaj specific catre infractor, ce-l informeaza cum ca este urmarit de un membru al politiei si trebuie sa traga imediat pe dreapta sau sa se predea.<br>Pentru ca mesajul sa fie trimis cu succes catre infractor, trebuie sa va aflati in apropierea acestuia si sa detineti un checkpoint activ generat de comanda /find asupra jucatorului urmarit.
...
- [Aplica in SF Police Departament](http://www.rpg.b-zone.ro/factions/apply/sfpd)
- [Membrii SF Police Departament](http://www.rpg.b-zone.ro/factions/members/sfpd)
- [Reclamatii SF Police Departament](http://www.rpg.b-zone.ro/factions/reports/sfpd)
- [Rapoarte de activitate SF Police Departament](http://www.rpg.b-zone.ro/factions/factionReports/sfpd)
- [Loguri SF Police Departament](http://www.rpg.b-zone.ro/factions/logs/sfpd)
- [Lista cu aplicatii SF Police Departament](http://www.rpg.b-zone.ro/factions/applications/sfpd)
