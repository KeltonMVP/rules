...
Hitmen Agency - Agentia de asasini in traducere directa.
Una dintre cele mai respectate factiuni, familia jucatorilor de elita dupa cum este numita. Tot ce trebuie sa faci este sa indeplinesti favorurile unor indivizi, plata se face inainte urmand ca tu sa indeplinesti un contract. Esti un simplu om in ochii celor din jur, insa mintea ta descrie calitatile agentiei. Un adevarat membru al acestei factiuni trebuie in primul rand sa exceleze prin abilitati mentale, agilitate si perfectiune. Aveti sansa de a da un test pentru intrare in cazul in care aplicatia voastra este acceptata de catre lider. In majoritatea cazurilor factiunea cauta cat mai multa experienta si o calitate foarte importanta, scrierea corecta in limba romana.

Agentia dispune de un numar limitat de vehicule precum Sparrow, Buffalo. De cele mai multe ori membrii agentiei aleg calea cea mai usoara, aceasta fiind folosirea naturii, tehnologiei. Cele 3 orase au nevoie de liniste, cetatenii de o viata normala si desigur agentia are nevoie de clienti multumiti.
...
2. Daca tinta este inchisa de catre politisti sau admini.
3. Daca tinta este mafiot si participa la war.
4. Daca tinta este intr-un clan si participa la clan war.
5. Daca tinta este in lumea virtuala a jail-ului.
...
- [Reclamatii Hitmen Agency](http://www.rpg.b-zone.ro/factions/reports/hitmen)
- [Rapoarte de activitate Hitmen Agency](http://www.rpg.b-zone.ro/factions/factionReports/hitmen)
- [Loguri Hitmen Agency](http://www.rpg.b-zone.ro/factions/logs/hitmen)
- [Lista cu aplicatii Hitmen Agency](http://www.rpg.b-zone.ro/factions/applications/hitmen)
