...
<figure markdown="span">
  ![Locatie HQ](/images/wiki/general/SchoolInstructorsMAP.png){ width="350" }
...
**Nota: Toate aplicatiile trebuie trimise in limba engleza intrucat factiunea SF School Instructors este in principiu o factiune engleza. Daca esti roman si cunosti limba engleza, atunci esti liber sa aplici.**

## Licente & descriere generala

SF School Instructors va poate inmana oricare dintre urmatoarele licente contra unei sume de bani fixata prin regulamentul factiunii respective si pe care toti instructorii sunt oblicati sa-l respecte:

1. Weapon (puteti detine o arma)
2. Materials (puteti achizitiona materiale avand ca scop vinderea armelor sau a materialelor procurate)
3. Fishing (permite pescuitul legal)
4. Flying (permite pilotarea unui avion/elicopter)
5. Sailing (permite navigarea unei barci)
...
**De mentionat faptul ca acesta este nivelul minim cerut de server, regulamentul intern posibil sa nu permita anumite licente de la acelasi nivel.**

## NPC achizitionare sau reinoire licente
...
<figure markdown="span">
  ...
  <figcaption>#2 Dialogul pentru selectarea licentei dorite si pretul acesteia de achizitionare</figcaption>
</figure>

- Langa intrarea in Training Room exista un NPC de la care jucatorii isi pot achizitiona sau reinoi licentele dorite direct fara a mai fi nevoie sa sustina test pentru aceastea.
- Aceasta posibilitate este disponibila numai daca jucatorul a incercat deja solicitarea unui instructor iar in decursul a 5 minute solicitarea acestuia nu a fost acceptata de niciun instructor aflat la datorie.
...
- [Aplica in School Instructors SF](http://www.rpg.b-zone.ro/factions/apply/sfinstructors)
- [Membrii School Instructors SF](http://www.rpg.b-zone.ro/factions/members/sfinstructors)
- [Reclamatii School Instructors SF](http://www.rpg.b-zone.ro/factions/reports/sfinstructors)
- [Rapoarte de activitate School Instructors SF](http://www.rpg.b-zone.ro/factions/factionReports/sfinstructors)
- [Loguri School Instructors SF](http://www.rpg.b-zone.ro/factions/logs/sfinstructors)
- [Lista cu aplicatii School Instructors SF](http://www.rpg.b-zone.ro/factions/applications/sfinstructors)
