...
<figure markdown="span">
  ![Logo factiune](/images/wiki/general/ParamediscLOGO.png){ width="300" }
  <figcaption>Logo-ul factiunii</figcaption>
</figure>

<figure markdown="span">
  ![Locatie HQ](/images/wiki/general/Parahq.png){ width="350" }
...
* Daca medicul nu reuseste sa transporte un cadavru in decurs de 15 minute, acesta va fi pierdut automat si nu va mai putea fi transportat.
* Daca medicul se indreapta inspre un cadavru si nu reuseste sa-l ridice in decurs de 10 minute, paramedicul va pierde dreptul de a-l mai ridica, cadavrul in cauza ramanand la locatia respectiva pana se va descompune sau un alt medic il va ridica.
* Daca jucatorul moare (respawn de la admini / omorat de hitman etc.) pe durata transportului, cadavrul va fi pierdut automat si nu va mai putea fi transportat.
...
#### Rank 1
1. Pentru un heal acordat: castig = [(50 * 5.5) * (0.1 + 1.0 + (1/10.0)] = 330$
2. Pentru un rehab acordat: castig = 1,500$ per 10 puncte de dependenta.
3. Pentru un cadavru transportat: castig =  [(15 * 65) * (0.1 + 1.0 + (1/10.0))] = 1,170$

#### Rank 2
1. Pentru un heal acordat: castig = [(50 * 5.5) * (0.2 + 1.0 + (2/10.0)] = 385$
2. Pentru un rehab acordat: castig = 1,500$ per 10 puncte de dependenta.
3. Pentru un cadavru transportat: castig =  [(15 * 65) * (0.2 + 1.0 + (2/10.0))] = 1,365$

#### Rank 3
1. Pentru un heal acordat: castig = [(50 * 5.5) * (0.3 + 1.0 + (3/10.0)] = 440$
2. Pentru un rehab acordat: castig = 1,500$ per 10 puncte de dependenta.
3. Pentru un cadavru transportat: castig =  [(15 * 65) * (0.3 + 1.0 + (3/10.0))] = 1,560$

#### Rank 4
1. Pentru un heal acordat: castig = [(50 * 5.5) * (0.4 + 1.0 + (4/10.0)] = 495$
2. Pentru un rehab acordat: castig = 1,500$ per 10 puncte de dependenta.
3. Pentru un cadavru transportat: castig =  [(15 * 65) * (0.4 + 1.0 + (4/10.0))] = 1,755$

#### Rank 5
1. Pentru un heal acordat: castig = [(50 * 5.5) * (0.5 + 1.0 + (5/10.0)] = 550$
2. Pentru un rehab acordat: castig = 1,500$ per 10 puncte de dependenta.
3. Pentru un cadavru transportat: castig =  [(15 * 65) * (0.5 + 1.0 + (5/10.0))] = 1,950$

#### Rank 6
1. Pentru un heal acordat: castig = [(50 * 5.5) * (0.6 + 1.0 + (6/10.0)] = 605$
2. Pentru un rehab acordat: castig = 1,500$ per 10 puncte de dependenta.
3. Pentru un cadavru transportat: castig =  [(15 * 65) * (0.6 + 1.0 + (6/10.0))] = 2,145$

### Pentru jucatorii cu cont premium

#### Rank 1
1. Pentru un heal acordat: castig = [(50 * 5.5) * (0.1 + 1.5 + (1/10.0)] = 467$
2. Pentru un rehab acordat: castig = 1,500$ per 10 puncte de dependenta.
3. Pentru un cadavru transportat: castig =  [(15 * 65) * (0.1 + 1.5 + (1/10.0))] = 1,657$

#### Rank 2
1. Pentru un heal acordat: castig = [(50 * 5.5) * (0.2 + 1.5 + (2/10.0)] = 522$
2. Pentru un rehab acordat: castig = 1,500$ per 10 puncte de dependenta.
3. Pentru un cadavru transportat: castig =  [(15 * 65) * (0.2 + 1.5 + (2/10.0))] = 1,852$

#### Rank 3
1. Pentru un heal acordat: castig = [(50 * 5.5) * (0.3 + 1.5 + (3/10.0)] = 577$
2. Pentru un rehab acordat: castig = 1,500$ per 10 puncte de dependenta.
3. Pentru un cadavru transportat: castig =  [(15 * 65) * (0.3 + 1.5 + (3/10.0))] = 2,047$

#### Rank 4
1. Pentru un heal acordat: castig = [(50 * 5.5) * (0.4 + 1.5 + (4/10.0)] = 632$
2. Pentru un rehab acordat: castig = 1,500$ per 10 puncte de dependenta.
3. Pentru un cadavru transportat: castig =  [(15 * 65) * (0.4 + 1.5 + (4/10.0))] = 2,242$

#### Rank 5
1. Pentru un heal acordat: castig = [(50 * 5.5) * (0.5 + 1.5 + (5/10.0)] = 687$
2. Pentru un rehab acordat: castig = 1,500$ per 10 puncte de dependenta.
3. Pentru un cadavru transportat: castig =  [(15 * 65) * (0.5 + 1.5 + (5/10.0))] = 2,437$

#### Rank 6
1. Pentru un heal acordat: castig = [(50 * 5.5) * (0.6 + 1.5 + (6/10.0)] = 742$
2. Pentru un rehab acordat: castig = 1,500$ per 10 puncte de dependenta.
...
* Medicul este la datorie.
* ID-ul cadavrului este valid ~ ID-ul apartine unui cadavru existent inspre care nu se indreapta alt medic.
...
- [Reclamatii Paramedics](http://www.rpg.b-zone.ro/factions/reports/paramedics)
- [Rapoarte de activitate Paramedics](http://www.rpg.b-zone.ro/factions/factionReports/paramedics)
- [Loguri Paramedics](http://www.rpg.b-zone.ro/factions/logs/paramedics)
- [Lista cu aplicatii Paramedics](http://www.rpg.b-zone.ro/factions/applications/paramedics)
