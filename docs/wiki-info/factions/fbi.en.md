...
Federal Bureau of Investigations is a governmental department, with a major importance in solving criminal cases from the three cities.
Having its headquarters in San Fierro, agents have at their disposal a spacious building to operate freely. With maximum strictness regarding the rules, the director chooses agents capable of working under pressure. Having state-of-the-art vehicles capable of surpassing any limit, agents manage to catch even the most agile criminal.
If you like strictness and adrenaline, this is the right place for you.

## Faction Skins

**Note: The ranks of skins are general, these may be different depending on the internal regulations of the faction.**
...
<figure markdown="span">![Skin 76](/images/wiki/skins/76.png){ width="250" }<figcaption>Skin 76</figcaption></figure>
...
#### Rank 1
1. For an arrested suspect: earning = [2,43 * (247 + random(15) + 10 * WantedLevel)] * 1,1
2. For a suspect caught escaping: earning = [2,43 * (247 + random(15) + 100)] * 1,1

#### Rank 2
1. For an arrested suspect: earning = [2,43 * (247 + random(15) + 10 * WantedLevel)] * 1,2
2. For a suspect caught escaping: earning = [2,43 * (247 + random(15) + 100)] * 1,2

#### Rank 3
1. For an arrested suspect: earning = [2,43 * (247 + random(15) + 10 * WantedLevel)] * 1,3
2. For a suspect caught escaping: earning = [2,43 * (247 + random(15) + 100)] * 1,3

#### Rank 4
1. For an arrested suspect: earning = [2,43 * (247 + random(15) + 10 * WantedLevel)] * 1,4
2. For a suspect caught escaping: earning = [2,43 * (247 + random(15) + 100)] * 1,4

#### Rank 5
1. For an arrested suspect: earning = [2,43 * (247 + random(15) + 10 * WantedLevel)] * 1,5
2. For a suspect caught escaping: earning = [2,43 * (247 + random(15) + 100)] * 1,5

#### Rank 6 or Leader
1. For an arrested suspect: earning = [2,43 * (247 + random(15) + 10 * WantedLevel)] * 1,6
2. For a suspect caught escaping: earning = [2,43 * (247 + random(15) + 100)] * 1,6
...
#### Rank 2
1. For an arrested suspect: earning = [2,43 * (247 + random(15) + 10 * WantedLevel)] * 1,7
2. For a suspect caught escaping: earning = [2,43 * (247 + random(15) + 100)] * 1,7

#### Rank 3
1. For an arrested suspect: earning = [2,43 * (247 + random(15) + 10 * WantedLevel)] * 1,8
2. For a suspect caught escaping: earning = [2,43 * (247 + random(15) + 100)] * 1,8

#### Rank 4
1. For an arrested suspect: earning = [2,43 * (247 + random(15) + 10 * WantedLevel)] * 1,9
2. For a suspect caught escaping: earning = [2,43 * (247 + random(15) + 100)] * 1,9

#### Rank 5
1. For an arrested suspect: earning = [2,43 * (247 + random(15) + 10 * WantedLevel)] * 2
2. For a suspect caught escaping: earning = [2,43 * (247 + random(15) + 100)] * 2

#### Rank 6 or Leader
1. For an arrested suspect: earning = [2,43 * (247 + random(15) + 10 * WantedLevel)] * 2,1
2. For a suspect caught escaping: earning = [2,43 * (247 + random(15) + 100)] * 2,1
...
* The price of a release warrant can be a minimum of $5,000 and a maximum of $20,000.
...
### /namecover
This command gives an agent a new name if they are undercover. You need a minimum rank of 5+ in this department to use this command.

### /ftalkpower
Through this command a member with rank 5+ can disable faction chat for members with rank lower than the one chosen by them.

### /fwithdrawpower
Through this command the faction leader can establish the minimum rank for withdrawing money, drugs and materials from HQ.
