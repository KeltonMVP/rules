...
- Comanda afiseaza informatii despre jucatorul respectiv:
  ...
  - Tipul de skin pe care il detine (Daca acesta poarta un skin [Diamond sau Onyx](/wiki-info/other-systems/egyptian-trader-shop/)).
...
- Cu ajutorul acestei comenzi, puteti cumpara obiecte din magazinele [24/7](/wiki-info/business/24-7).
...
- Cu aceasta comanda puteti cumpara bauturi din [cluburi si baruri](/wiki-info/business/clubs-bars).
...
- Intrati si iesiti din [modul AFK](/wiki-info/useful-commands/houses/#sleep).

## /lotto

_Sintaxa: /lotto_

- Plasati bilete cu diferite numere la sistemul de [lotto](/wiki-info/other-systems/lotto/).
...
- [Jefuiti](/wiki-info/other-systems/rob) banca intr-un grup format din 4-8 persoane sau puteti selecta optiunea "Rob Solo" si veti putea jefui o casa/afacere singuri.

## /robhelp

_Sintaxa: /robhelp_

- Ofera informatii legate de [sistemul de jaf](/wiki-info/other-systems/rob).
...
- Comanda trimite o cerere de instiintare catre administratorii serverului. Daca vi se accepta cererea, un admin va va deschide reportul. Puteti sa vorbiti cu acesta prin comanda [/al](/wiki-info/useful-commands/chat#al).
...
- Aveti posibilitatea de [a folosi drogurile detinute](/wiki-info/other-systems/drugs).

## /fill

_Sintaxa: /fill [procent]_

- Va [umpleti](/wiki-info/business/gas-stations#fill) rezervorul de combustibil cu procentul introdus.

## /fillgascan

_Sintaxa: /fillgascan_

- Va [umpleti](/wiki-info/business/gas-stations#fillgascan) canistra de combustibil.
...
NPC achizitionare licenta arme
...
**Nota: Necesita un MP3 Player (achizitionabil dintr-un [24/7](/wiki-info/business/24-7)) si cont premium.**
...
- Trimite o invitatie la negot unui alt jucator, folosind sistemul de [trading](/wiki-info/other-systems/trade).
...
- Aceasta comanda va arata lista cu toate [safebox-urile](/wiki-info/other-systems/safebox) pe care le detineti pe cont, impreuna cu amplasarea acestuia pe harta si capacitatea ocupata din capacitatea totala al acestuia.

## /opensafe

- Aceasta comanda va permite sa deschideti [safebox-ul](/wiki-info/other-systems/safebox) pe care l-ati amplasat pe harta pentru a depozita/extrage/arunca arme/droguri/materiale din aceasta.
...
- Aceasta comanda va arata lista cu [cei mai activ 15 jucatori](/wiki-info/other-systems/gold-award) de pe server la orele reale jucate (fara sleep).

## /premiu

- Aceasta comanda va arata tier-ul curent de la [sistemul de cufar](/wiki-info/other-systems/rewards-chest-system) impreuna cu numarul de ore **reale** jucate pe ziua respectiva.
