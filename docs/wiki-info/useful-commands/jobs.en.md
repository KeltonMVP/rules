...
With this command, any player can get employed, if they meet the following conditions:
...
This command is one of the most used commands regarding jobs. With this command, a player can start their work. The /work command works for all jobs, except Detective, Auto Mechanic and Lawyer.
...
_Note: To help your imagination, you can find such a list in image #3._
