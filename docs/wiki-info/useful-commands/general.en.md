...
- The command displays information about that player:
  ...
  - Type of skin they have (If they wear a [Diamond or Onyx](/en/wiki-info/other-systems/egyptian-trader-shop/) skin).
  - Their skin ID.
...
- With this command, you can buy items from [24/7](/en/wiki-info//business/24-7) stores.
...
- With this command you can buy drinks from [clubs and bars](/en/wiki-info//business/clubs-bars).
...
- Enter and exit [AFK mode](/en/wiki-info/useful-commands/houses/#sleep).

## /lotto

_Syntax: /lotto_

- Place tickets with different numbers in the [lotto](/en/wiki-info/other-systems/lotto/) system.
...
- [Rob](/en/wiki-info//other-systems/rob) the bank in a group of 4-8 people or you can select the "Rob Solo" option and you can rob a house/business alone.

## /robhelp

_Syntax: /robhelp_

- Provides information related to the [robbery system](/en/wiki-info//other-systems/rob).
...
- The command sends a notification request to the server administrators. If your request is accepted, an admin will open your report. You can talk to them using the [/al](/en/wiki-info//useful-commands/chat#al) command.
...
- You have the possibility to [use the drugs you own](/en/wiki-info//other-systems/drugs).

## /fill

_Syntax: /fill [percent]_

- You [fill](/en/wiki-info//business/gas-stations#fill) the fuel tank with the entered percentage.

## /fillgascan

_Syntax: /fillgascan_

- You [fill](/en/wiki-info//business/gas-stations#fillgascan) the fuel canister.
...
**Note: Requires an MP3 Player (purchasable from a [24/7](/en/wiki-info//business/24-7)) and premium account.**
...
- Sends a trade invitation to another player, using the [trading](/en/wiki-info//other-systems/trade) system.
...
- This command shows you the list of all [safeboxes](/en/wiki-info//other-systems/safebox) you own on your account, along with its location on the map and the occupied capacity out of its total capacity.

## /opensafe

- This command allows you to open the [safebox](/en/wiki-info//other-systems/safebox) you placed on the map to deposit/extract/throw weapons/drugs/materials from it.
...
- This command shows you the list of [the most active 15 players](/en/wiki-info//other-systems/gold-award) on the server by real hours played (without sleep).

## /premiu

- This command shows you the current tier from the [chest system](/en/wiki-info//other-systems/rewards-chest-system) along with the number of **real** hours played that day.
