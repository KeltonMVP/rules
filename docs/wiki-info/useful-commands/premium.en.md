...
The command can only be used near the "CarColor" business and has the effect of teleporting the car into the color selection menu. There you can select special colors for your vehicle using gold, colors that cannot be accessed by simply typing the /carcolor command. The color selection menu is welcoming and extremely easy to use.
