...
Each tenant you have and who is online (connected to the server) at [PayDay](/other-systems/payday) will be deducted the respective amount of dollars, the money will be deposited in the house safe.  
...
If you sleep at [PayDay](/other-systems/payday) time, you will receive the respect point necessary to advance in level, but the number of hours played will not increase.
...
The command has the effect of withdrawing money from the house safe, money produced from the rent that tenants pay at each [PayDay](/other-systems/payday).
...
- To have a lift at your house you can open a ticket [here](https://www.rpg.b-zone.ro/ticket/addSupportTicket) and you can purchase one in exchange for the amount of 10 Euro / 50 RON per level.
