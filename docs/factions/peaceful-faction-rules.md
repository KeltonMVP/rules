...
Fiecare membru de rank 1-5 (exceptie Subliderii) are obligatia de a efectua raport de activitate.<br/>
Adminii si Helperii vor avea un raport de activitate redus fata de restul membrilor.<br/>
Fraudarea sau ajutarea unui coleg sa fraudeze raportul de activitate este strict interzisa (<span style="color:red;">sanctiune: demitere</span>).
...
In cazul in care se organizeaza o activitate obligatorie in cadrul factiunii, singurul loc in care puteti sa va invoiti este pe website-ul RPG printr-o cerere de invoire.
